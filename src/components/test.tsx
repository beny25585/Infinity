  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-black to-gray-800 text-white">
      <section className="max-w-6xl mx-auto px-4 py-12">
        <h2 className="text-center text-4xl font-bold mb-8">המלצות חניכים</h2>

        <div className="overflow-x-auto snap-x snap-mandatory flex  space-x-6 px4 pb-6 scrollbar-hide">
          {recommendations.map((rec, index) => (
            <div
              key={index}
              className="snap-center snap-always shrink-0 w-full h-full bg-black/80 backdrop-blur-sm border border-gray-600 rounded-2xl p-6 shadow-2xl flex flex-col justify-between"
            >
              <div>
              ...
              <p className="text-cyan-200 font-semibold text-right leading-relaxed mt-4 mb-6">
                "{rec.text}"
              </p>
