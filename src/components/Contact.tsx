...
const Contact: React.FC = () => {
  ...
  return (
    <section
      className="  flex flex-col items-center justify-center py-12 mx-auto  max-w-7xl z-10   p-6 sm:p-8 lg:p-10"
      dir="rtl"
      style={{
    ...
    >
      <div className="bg-white/20  rounded-2xl shadow-2xl p-8 mt-8 flex flex-col items-center">
        <h2 className="text-4xl font-extrabold  text-center gradient-text text-black">
          צרו קשר
        </h2>
        <ChevronsDown className="animate-bounce w-8 h-8 mt-8" />
